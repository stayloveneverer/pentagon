...
function startstop(){
if (document.getElementById("startstop").innerHTML=="スタート"){

sensor_on(); //開始
document.getElementById("startstop").innerHTML="ストップ";
...
var seconds = ("0"+date.getSeconds()).slice(-2);
  ...
  download.setAttribute('download',+ year + '/'+ month +'/'+ day +","+ hours +":"+ minutes +":"+ seconds +'.csv');
